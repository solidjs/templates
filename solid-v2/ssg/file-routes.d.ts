...
declare module "virtual:file-routes" {
  ...
  const routes: readonly [
    ...
    },
    {
      path: "/posts/:slug";
      page: true;
      $component: FileRouteLazyRef<typeof import("./src/routes/posts/[slug]")>;
      $$route: FileRouteEagerRef<typeof import("./src/routes/posts/[slug]")>;
    },
    {
      path: "/posts/";
      page: true;
      $component: FileRouteLazyRef<typeof import("./src/routes/posts/index")>;
      $$route?: undefined;
    }
  ];
